 ...
 *
 * <p>Contains data for a players jump and run course.
 *
...
public class Course {
  ...
  /**
   * Gets the checkpoints for this course. If all checkpoints have been reached, the returned {@link
   * Location} is the end of the course.
   */
