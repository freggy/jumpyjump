 ...
 *
 * <p>Takes care of map selection and loading. The map that will be loaded is defined in the
 * environment variable {@code MAP}. It can be retrieved by using {@link System#getenv(String)}.
 *
